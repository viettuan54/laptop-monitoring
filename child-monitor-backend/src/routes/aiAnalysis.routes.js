...
router.post('/analyze/:device_id', auth, requireRole('parent'), aiAnalysisLimiter, withRls, aiAnalysisController.triggerAnalysis);

// Lấy báo cáo tóm tắt bằng ngôn ngữ tự nhiên
router.get('/summary/:device_id', auth, requireRole('parent'), aiSummaryLimiter, withRls, aiAnalysisController.getSummaryReport);
